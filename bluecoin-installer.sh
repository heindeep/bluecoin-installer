...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bluecoin.conf'
CONFIGFOLDER='/root/.bluecoin'
COIN_DAEMON='bluecoind'
COIN_CLI='bluecoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/heindeep/bluecoin/releases/download/V1.0%2C0/bluecoin-1.0.0-linux64.tar.gz'
